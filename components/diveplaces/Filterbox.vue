<template>
  <div class="filter-container">
    ...
    <div class="form-group">
      <label for="depth">Max. głębokość: <span id="depthValue">{{depth}}</span> m</label>
      <input name ="depth" v-model="depth" type="range" min="1" max="150" style="width: 100%">
		</div>
    <div class="form-group">
      <label for="sight">Min. Widoczność: <span id="sightValue">{{sight}}</span> m</label>
    ...
    <button id="submit-button" type="submit" class="btn btn-primary" style="width: 100%">Search</button>
  </div>
</template>
